...
pe_hydro_step_c.set_deco_cost(0) # don't know
...
pe_hydro_step_d.set_deco_cost(0) # don't know
...
#ps_hydro_step.set_level_max(100e3) # 5e3MW during 20 hours
ps_hydro_step.set_level_max_time(20) # 20h => CF Q. Perrier
ps_hydro_step.set_level_min(0)   # MWh
ps_hydro_step.set_level_start(0) # MWh
