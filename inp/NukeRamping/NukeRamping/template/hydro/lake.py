...
E = {(y,w,h): pt_hydro_lake.get_P()[y] * dict_lake_lf[y,w,h] for y in years for w in weeks for h in hours}
...
pe_hydro_lake.set_deco_cost(0) # don't know
